...
//   const username = useState(JSON.parse(localStorage.getItem('TOKEN_KEY')).username);

//   const handleClickCancelEdit = () => {};

//   return (
//       <div>
//         <UpdateAccount usernsme={username} handleClickCancelEdit={handleClickCancelEdit} />
//       </div>
//   );
// }
...
export default function UpdatePage() {
  ...
  const handleClickDelete = () => {
    console.log("UUU", deleteUsernsme);
